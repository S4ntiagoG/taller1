...
public class Taller1 {
    ...
    public static void main(String[] args) {
       ...
       System.out.println(Convertir_cent_far(19));
       System.out.println(Calcular_peso_carga((float)90, (float)45 ));
       System.out.println(Calcular_combustible(1123, 31234, 555, 667));
       System.out.println(Calcular_segs((byte)23, (byte)14, (byte)13, (byte)1));
       System.out.println(Calcular_horasxviaje("Micasa", (short)90, (short)20));
       System.out.println(Calcular_peso_luna((byte)40));
    }
